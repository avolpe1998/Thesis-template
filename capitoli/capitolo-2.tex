...
Nell'incontro sono state prese in considerazione le \gls{API} \gls{REST} esistenti di cui doveva essere fatta la migrazione.
E' emerso subito che la quantità di \gls{API} \gls{REST} da migrare era troppo elevata per il
...
La scelta di replicare lo stato dei sensori nel \gls{back-end} è stata fatta per trarne i seguenti benefici:
\begin{itemize}
